...
$content = Get-Content "GGXrdBackgroundGamepad.rc"
$newline = "`
"
$tab = "	";
...
if ($need_write) {
	Set-Content -Value ($content_lines -join $newline) "GGXrdBackgroundGamepad.rc" -Encoding Unicode
}
